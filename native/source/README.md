...
The initial source snapshot was copied from `db/duck.rs` in the desktop app.

Source SHA-256: `c828ca26090f8699aa2a5e04cca0f328732469aa938b47ecd2bd198877c104c0`.


This directory is a migration staging area for `irodori.duckdb`. The active native
